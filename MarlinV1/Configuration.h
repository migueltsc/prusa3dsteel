...
#define CUSTOM_MACHINE_NAME "iGnomo3D"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Ultimaker
  // MODIFICADO PID pruebas

  // #define  DEFAULT_Kp 22.2
  // #define  DEFAULT_Ki 1.08
  // #define  DEFAULT_Kd 114
  #define  DEFAULT_Kp 28.50
  #define  DEFAULT_Ki 1.40
  #define  DEFAULT_Kd 144.99
...
// default settings
// MODIFICADO eje z mal calibrado
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,800,185}  // default steps per unit for Ultimaker
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,796.02,185}  // default steps per unit for Ultimaker
